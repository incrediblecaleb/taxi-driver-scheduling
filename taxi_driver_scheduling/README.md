...
*7. Next Steps*
I would continue to analyze the outliers (trips with distance more than 15 miles) to reveal any hidden insights and  conduct hypothesis testing to verify whether all the generated insights are accurate. 
